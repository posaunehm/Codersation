...
public class AmountTest {
    ...
    public void 自販機に10円を投入すると投入金額合計が10円になる() {
        amount.insert(AcceptableMoneyFactory.createNewMoney(10));
        assertThat(amount.getTotal(), is(10));
    }
    
    @Test
    public void 自販機に100円を投入すると投入金額合計が100円になる() {
        amount.insert(AcceptableMoneyFactory.createNewMoney(100));
        assertThat(amount.getTotal(), is(100));
    }
    
    @Test
    public void 自販機に50円と500円を投入すると投入金額合計が550円になる() {
        amount.insert(AcceptableMoneyFactory.createNewMoney(50));
        amount.insert(AcceptableMoneyFactory.createNewMoney(500));
        assertThat(amount.getTotal(), is(550));
    }
    
    @Test
    public void 自販機に1000円と100円を投入して払い戻しを行うと投入金額合計が0円になる() {
        amount.insert(AcceptableMoneyFactory.createNewMoney(1000));
        amount.insert(AcceptableMoneyFactory.createNewMoney(100));
        amount.payBack();
    ...
    public void 自販機に1円を投入すると例外がスローされる() {
        AcceptableMoneyFactory.createNewMoney(1);
    }
}
